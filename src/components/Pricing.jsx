...
const Pricing = () => {
    ...
    const packages = [
        {name: "Start", monthlyPrice: 19, yearlyPrice: 199, description : "A common form of lorem ipsum reads: lorem ipsum dolor sir amet, consectetur adipscing elit.", green : "/src/assets/dot.png"},
        {name: "Advance", monthlyPrice: 39, yearlyPrice: 399, description : "A common form of lorem ipsum reads: lorem ipsum dolor sir amet, consectetur adipscing elit." , green : "/src/assets/dot.png"},
        {name: "Premium", monthlyPrice: 59, yearlyPrice: 599, description : "A common form of lorem ipsum reads: lorem ipsum dolor sir amet, consectetur adipscing elit.", green : "/src/assets/dot.png"},
    ]
  ...
  return (
    <div className="md:px-14 p-4 max-w-s mx-auto py-10">
        ...
        <p className="text-tartiary md:w-1/3 mx-auto px-4">A Simple paragraph is compirised of three major components. The which is often a declarative sentence.</p>
        {/* toggle pricing */}
        <div className="mt-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto">
            {
                packages.map((pkg, index) => <div key={index} className="border py-10 md:px-6 px-4 rounded-lg shadow-3xl">
                    ...
                    <ul className="mt-4 space-y-2 px-4">
                        ...
                        <li className="flex gap-3 items-center"><img src={pkg.green} alt="" className="w-4 h-4" />Home Work</li>
                        <li className="flex gap-3 items-center"><img src={pkg.green} alt="" className="w-4 h-4" />Additional practical task</li>
                        <li className="flex gap-3 items-center"><img src={pkg.green} alt="" className="w-4 h-4" />Montly conferences</li>

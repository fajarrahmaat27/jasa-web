...
const Footer = () => {
  return (
    <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
        ...
        <a href="" className='text-2xl font-semibold flex items-center space-x-3 text-white'> <img src="#" alt="" className='w-10 inline-block items-center' /> LOGO</a>
        <p className="md:w-1/2 ">A simple paragraph is comprised of three major componenst. The first sentence, which often a delarative sentence.</p>
        <div>
